...
PAD_ID = 0  #I think this is how the embedding knows how to handle it when I pad a sentence with '0's
SOS_ID = 1
UNK_ID = 2
...
#I think this seperates words. I shouldn't need to touch this
...
"""def load_embeddings(args, helper):
    ...
    return embeddings
    """
#maps vocabulary to word embeddings. Should I be using this in my embeddings function in qa_model ? This doesn't return anythin
#above this I copied in the load_embeddings function from assignment3 data_util.py which is called when assigning self.pretrained embeddings
...
#not sure what :return: means here but there's nothing this returns. Does this mean I shouldn't be returning things whenever it says that? 
#Not necessarily, example: decode in qa_model
...
#creates a vocabulaty I guess. I don't think I have to edit this at all
...
#should this be modified in order to pad with zeros? Where do I pad with zeros?
